...
Ara afegirem les variables discretes explicatives que siguin significatives, ho farem a partir de les que ens indiqui el catdes, sempre sense repetir una variable si ja esta represetnada com a numerica. Mirem les colinearitats i eliminem les variables que en tinguin, per a continuaci� simplifcar el model amb la comanda step. Veiem com finalment el model gm44 es un model sense colinearitats, on tots els efectes de les variables explicatives son significatius.
```{r}
#discrete variables
...
gm44<-step(gm4, k=log(nrow(dfw))); vif(gm44); summary(gm44)
